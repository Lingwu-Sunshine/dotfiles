...
--       ["0"]="零",
   ...
   date3=date_y..date_m..date_d
    ...
    --date9 2020年6月6日星期六
    date9=os.date(date2)..os.date(day_w1)
   ...
   day_w5=os.date("%w")
   day_w4=""
  if day_w5=="0" then day_w4="周日" end
  if day_w5=="1" then day_w4="周一" end
  if day_w5=="2" then day_w4="周二" end
  if day_w5=="3" then day_w4="周三" end
  if day_w5=="4" then day_w4="周四" end
  if day_w5=="5" then day_w4="周五" end
  if day_w5=="6" then day_w4="周六" end
...
--      yield(Candidate("week", seg.start, seg._end, os.date(day_w2), "  "))
--      yield(Candidate("week", seg.start, seg._end, os.date(day_w4), "  "))
   end
